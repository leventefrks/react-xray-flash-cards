const CardBack = ({ modality, region, radiology, diagnose }) => {
  return (
    <div className="p-2 sm:p-4 h-[500px] space-y-2 flex flex-col justify-center bg-white rounded-md shadow-xl dark:shadow-none">
      <div className="flex flex-col">
        <span className="font-bold text-md text-gray-700">Modalitás</span>
        <span className="text-sm sm:text-md">{modality && modality}</span>
      </div>
      <div className="flex flex-col">
        <span className="font-bold text-md text-gray-700">Régió</span>
      ...
      <div className="flex flex-col">
        <span className="font-bold text-md text-gray-700">Diagnózis</span>
