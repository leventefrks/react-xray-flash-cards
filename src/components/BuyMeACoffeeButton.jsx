...
const BuyMeACoffeeButton = () => {
  return (
    <a
      className="duration-15 group flex items-center gap-2  rounded-md border-2 border-gray-600 p-2 text-gray-600 transition-all dark:border-gray-100 dark:text-gray-100"
      target="_blank"
